...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_TextureManager->Initialize(6);
	if(!result)
	{
	...
	result = m_TextureManager->LoadTexture(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/textures/rockPaint01_d.tga", 0);
	if (!result)
	{
		return false;
	}
